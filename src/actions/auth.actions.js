...
export const signin = (user) => {
    return async dispatch => {
        ...
        .catch(error => {
            console.log("The user doesn't exists! OR "+error);
...
export const logout = (uid) => {
    ...
    var lastSignInDate = auth().currentUser.metadata.lastSignInTime;
    lastSignInDate = (new Date(lastSignInDate)).toLocaleString();
